...
class DFSTest {
    ...
    @CsvSource({
            "3, '0-1, 1-2', '0,1,2'",
            "1, '', '0'",
            "4, '0-1, 0-2, 1-3, 2-3', '0,2,1,3'",
            "2, '', '1,0'",
            "5, '0-2, 1-2, 2-3, 2-4', '1,0,2,4,3'",
            "0, '', ''"
    })
    void testTopoSort(int n, String graphStr, String expectedStr) {
        ...
        assertEquals(expected, dfs.topoSort(n, graph));
    }
    ...
    void testCycle() {
        ...
        assertThrows(IllegalStateException.class, () -> dfs.topoSort(n, graph));
    }
